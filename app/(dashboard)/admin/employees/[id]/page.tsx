...
export default async function EmployeeDetailPage({
  ...
  const gridStart = addDaysToDateString(today, -29);
      ...
      <Card>
        ...
        <CardHeader>
          ...
          <CardDescription>
            ...
            Profile, department, salary, and employee type.
        ...
        <>
          ...
          <Card>
            ...
            <CardHeader>
              ...
              <CardDescription>Daily KPI flags</CardDescription>
                  ...
                  warnings.map((w) => (
                    ...
                    >
                      ...
                      <span>
                        ...
                        {w.warning_month.slice(0, 7)} · {w.red_flag_dates.length}{" "}
          ...
          <Card>
            ...
            <CardHeader>
              ...
              <CardDescription>
                ...
                Daily completion and flags for the last 30 days
